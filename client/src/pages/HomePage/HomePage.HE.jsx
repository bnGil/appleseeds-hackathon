...
const HomePageHE = () => {
  ...
  return (
    <div className="HomePage RTL">
      <section className="banner">
        <div className="section-bg"></div>
        <div className="text">
          <p>הכירו את המקומות היפים בעולם</p>
        </div>
      </section>
      ...
      <Card
          ...
          title="זכרונות בלתי נשכחים"
          desc="גלו מקומות מרהיבים, שלעולם לא תשכחו"
        />
      <Card
          ...
          title="השארו מעודכנים"
          desc="אתרים חדשים עולים כל הזמן, הקפידו להתעדכן מדי פעם!"
        />
      <Card
